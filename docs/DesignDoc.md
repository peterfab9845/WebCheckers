...
The Controller principle is also something our project made significant use of. The best example of this is the Board and BoardController classes; as the below figure shows, there are not very many methods in the Board class, and it contains very little logic.
